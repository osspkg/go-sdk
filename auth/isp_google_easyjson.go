...
func easyjson3bc980faDecodeGithubComDewepproGoSdkAuth(in *jlexer.Lexer, out *modelGoogle) {
...
func easyjson3bc980faEncodeGithubComDewepproGoSdkAuth(out *jwriter.Writer, in modelGoogle) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v modelGoogle) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3bc980faEncodeGithubComDewepproGoSdkAuth(&w, v)
...
func (v *modelGoogle) UnmarshalJSON(data []byte) error {
	...
	easyjson3bc980faDecodeGithubComDewepproGoSdkAuth(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *modelGoogle) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3bc980faDecodeGithubComDewepproGoSdkAuth(l, v)
}
