...
func easyjsonD1fc6ea8DecodeGithubComDewepproGoSdkAuth(in *jlexer.Lexer, out *modelYandex) {
...
func easyjsonD1fc6ea8EncodeGithubComDewepproGoSdkAuth(out *jwriter.Writer, in modelYandex) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v modelYandex) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD1fc6ea8EncodeGithubComDewepproGoSdkAuth(&w, v)
...
func (v *modelYandex) UnmarshalJSON(data []byte) error {
	...
	easyjsonD1fc6ea8DecodeGithubComDewepproGoSdkAuth(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *modelYandex) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD1fc6ea8DecodeGithubComDewepproGoSdkAuth(l, v)
}
